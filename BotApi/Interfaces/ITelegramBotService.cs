...
namespace BotApi.Interfaces
{
    public interface ITelegramBotService
    {
        ...
        Task SendTextMessageAsync(long chatId, string message, ParseMode parseMode = ParseMode.None);
        ...
        Task SendTextMessageWithButtonsAsync(Update update, string message, ReplyMarkup replyMarkup);
