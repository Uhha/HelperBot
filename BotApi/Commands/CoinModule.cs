...
namespace BotApi.Commands
{
    public class GetCoinsCommand: BaseCommandAsync
    {
        ...
        public GetCoinsCommand(ITelegramBotService telegramBotService, IOptions<APIConfig> apiConfig) :base(telegramBotService) 
        {
        ...
        private async Task<(string, bool)> GetPricesAsync(int currenciesNumber)
        {
